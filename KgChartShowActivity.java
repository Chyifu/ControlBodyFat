 ...
 */
public class KgChartShowActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_show_chart_kg);
    ...
    private OnClickListener BtnLeftMenu=new OnClickListener(){
        @Override
        public void onClick(View v) {
            ...
            intent.setClass(KgChartShowActivity.this,WaliHipsChartShowActivity.class);
            intent.putExtras(bund);
            startActivity(intent);
            KgChartShowActivity.this.finish();
        }
    };

    private OnClickListener BtnRightMenu=new OnClickListener(){
        @Override
        public void onClick(View v) {
            Bundle bund=new Bundle();
            long day;
            ...
            Intent intent=new Intent();
            intent.setClass(KgChartShowActivity.this,RateChartShowActivity.class);
            intent.putExtras(bund);
            startActivity(intent);
            KgChartShowActivity.this.finish();
        }
    ...
    private OnClickListener BtnLeftMon=new OnClickListener(){
        @Override
        public void onClick(View v) {
            MonthData.clear();
            kgchart.clear();
    ...
    private OnClickListener BtnRightMon=new OnClickListener(){
        @Override
        public void onClick(View v) {
            MonthData.clear();
            kgchart.clear();
    ...
    private LineData getData(List<BodyData> monthdata, int Month)
    {
        ...
        for(int i=1;i<MonthDay[Month-1];i++){
            for(int j=0;j<monthdata.size();j++){
                ...
                if(i==monthDay){
                    weight = monthdata.get(j).getWeight();
                    kgweight = monthdata.get(j).getFatWeight();
                    yVals2.add(new Entry((float) kgweight, monthDay));
                    yVals1.add(new Entry((float) weight, monthDay));
                    break;
                }
            }
        }
        ...
        LineDataSet set1=new LineDataSet(yVals1,"Weight (kg)");
        set1.setLineWidth(3);
        set1.setCircleSize(3f);
        set1.setColor(Color.GRAY);
        set1.setHighLightColor(Color.BLUE);

        LineDataSet set2=new LineDataSet(yVals2,"Fat Weight (kg)");
        set2.setLineWidth(3);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event){
        ...
        {
            Intent intent=new Intent();
            intent.setClass(KgChartShowActivity.this,MainActivity.class );
            startActivity(intent);
            KgChartShowActivity.this.finish();
            return true;
        }
